...
output received is 26.0, it should be printed as 26) In case of input data being supplied to the question, it should be
...
c = 50
h = 30
d_list = input("Enter the input sequence: ").split(",")
output_list = []
